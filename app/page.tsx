...
const portfolioItems: Array<{
  ...
  { src: "/manus-storage/wedding-story-03_459bc393.jpg", title: "A quiet glance before the room fills", category: "Wedding", categories: ["Weddings", "Cinematic", "Documentary"], ratio: "aspect-[4/5]" },
  { src: "/manus-storage/still-frame-story-01_987bbdce.jpg", title: "The pause before the ceremony", category: "Bridal portrait", categories: ["Weddings", "Portraits", "Cinematic"], ratio: "aspect-[3/4]" },
  { src: "/manus-storage/wedding-story-01_df4cf4eb.jpg", title: "Held in the smallest details", category: "Wedding", categories: ["Weddings", "Documentary"], ratio: "aspect-square" },
  { src: "/manus-storage/shanzae-faisal-mosque-wedding_5714f627.jpeg", title: "A new chapter beneath the minarets", category: "Wedding", categories: ["Weddings", "Portraits", "Travel"], ratio: "aspect-[4/5]" },
  { src: "/manus-storage/wedding-story-04_353ae226.jpg", title: "A celebration in full colour", category: "Wedding", categories: ["Weddings", "Events", "Cinematic"], ratio: "aspect-[3/4]" },
  { src: "/manus-storage/still-frame-story-02_8b639835.jpg", title: "When the families become one frame", category: "Ceremony", categories: ["Weddings", "Events", "Cinematic", "Documentary"], ratio: "aspect-[3/2]" },
  { src: "/manus-storage/wedding-story-05_f5daa8e2.jpg", title: "Light, laughter, and the long table", category: "Wedding", categories: ["Weddings", "Events", "Documentary"], ratio: "aspect-[4/5]" },
  { src: "/manus-storage/shanzae-portrait-story_62b3977b.jpeg", title: "A portrait with a sense of place", category: "Portrait", categories: ["Portraits", "Corporate", "Travel"], ratio: "aspect-[4/5]" },
  { src: "/manus-storage/wedding-story-02_70c2acb3.jpg", title: "The first turn on the dance floor", category: "Wedding", categories: ["Weddings", "Events", "Cinematic"], ratio: "aspect-[2/3]" },
  { src: "/manus-storage/still-frame-studio-portrait_85936cc9.jpg", title: "The observer and the instrument", category: "Studio portrait", categories: ["Portraits", "Corporate", "Documentary"], ratio: "aspect-square" },
  { src: "/manus-storage/wedding-story-06_15c3e367.jpg", title: "A moment worth coming back to", category: "Wedding", categories: ["Weddings", "Events", "Documentary"], ratio: "aspect-[4/5]" },
];
      ...
      >
        <div className="editorial-shell flex h-[5.25rem] items-center justify-between">
          <a href="#top" className="flex items-center focus-visible:ring-2 focus-visible:ring-foreground/50" aria-label="Shanzae Zia home">
            <img src="/manus-storage/shanzae-supplied-logo_84810e5d.png" alt="Shanzae Zia Photography" className="h-14 w-auto rounded-xl bg-transparent object-contain p-1" />
          </a>
        ...
        <section id="about" className="border-t border-border py-16 md:py-24" aria-labelledby="about-heading">
          <div className="editorial-shell grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1fr)] lg:gap-20">
            <motion.div initial={reduceMotion ? false : { opacity: 0, x: -24 }} whileInView={reduceMotion ? undefined : { opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.7, ease: EASE }} className="image-frame group relative aspect-square overflow-hidden bg-card">
              <EditorialImage src="/manus-storage/shanzae-profile_b52c957d.jpg" alt="Shanzae Zia, photographer and visual storyteller" className="h-full w-full object-cover object-center" />
        ...
        <section className="border-t border-border py-16 md:py-24" aria-label="A photographic interruption">
          <div className="editorial-shell grid grid-cols-1 gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
            <div className="grid grid-cols-[1.15fr_0.85fr] gap-3">
              <div className="image-frame group relative aspect-[4/5] overflow-hidden bg-card"><EditorialImage src="/manus-storage/still-frame-story-02_8b639835.jpg" alt="Cinematic wedding ceremony captured in black and white" className="h-full w-full object-cover" /></div>
              <div className="image-frame group mt-12 aspect-[3/4] overflow-hidden bg-card lg:mt-20"><EditorialImage src="/manus-storage/wedding-story-05_f5daa8e2.jpg" alt="Shanzae Zia wedding photography detail" className="h-full w-full object-cover" /></div>
            </div>
        ...
        <section data-static-motion className="editorial-dark relative overflow-hidden border-t border-border py-16 md:py-24" aria-labelledby="motion-heading">
          ...
          <div className="editorial-shell relative grid grid-cols-1 gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-center lg:gap-20">
            ...
            <figure className="image-frame group relative aspect-[16/10] overflow-hidden border border-primary/30 bg-card shadow-[0_30px_70px_-38px_oklch(0.8_0.04_78/0.25)]">
              <EditorialImage src="/manus-storage/wedding-story-04_353ae226.jpg" alt="Cinematic wedding celebration by Shanzae Zia" sizes="(min-width: 1024px) 58vw, 100vw" className="h-full w-full object-cover object-center" />
